...
<head>
    ...
    <title>View Complaints or Suggestions</title>
...
<body>
    ...
    <div class="content">
        ...
        <header class="header">
            <h1>View Complaints or Suggestions</h1>
        </header>
        ...
        <section class="case-list">
            ...
            if ($CSResult->num_rows > 0) {
                while ($CS = $CSResult->fetch_assoc()) {
                    ...
                    echo '<a href="../functions/display_complaint_suggestion_function.php?case_id=' . $CS['ComplaintSuggestionID'] . '">' . htmlspecialchars($CS['Title']) . '</a>';
                    echo '</div>';
                }
            } else {
                echo '<p>No complaints or suggestions found.</p>';
            }
            ?>
        </section>
    </div>
